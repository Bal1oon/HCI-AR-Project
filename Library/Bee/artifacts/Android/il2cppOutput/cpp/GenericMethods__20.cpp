...
FINALLY_0028:
			{
				Enumerator_Dispose_mD9DC3E3C3697830A4823047AB29A77DBBB5ED419((&V_0), il2cpp_rgctx_method(method->rgctx_data, 7));
				return;
			}
		});
		try
...
IL_001d_1:
			{
				bool L_4;
				L_4 = Enumerator_MoveNext_mE921CC8F29FBBDE7CC3209A0ED0D921D58D00BCB((&V_0), il2cpp_rgctx_method(method->rgctx_data, 6));
				if (L_4)
				{
					goto IL_000c_1;
				}
...
IL_0036:
	{
		...
		NullCheck(L_5);
		List_1_Clear_m16C1F2C61FED5955F10EB36BC1CB2DF34B128994_inline(L_5, il2cpp_rgctx_method(method->rgctx_data, 8));
	}
...
IL_001c:
	{
		...
		NullCheck(L_10);
		((Link_t3E237FC972997681510F43C6555571385C91BE05*)L_10)->___Finger = L_11;
		Il2CppCodeGenWriteBarrier((void**)(&((Link_t3E237FC972997681510F43C6555571385C91BE05*)L_10)->___Finger), (void*)L_11);
...
IL_000c_1:
			{
				...
				NullCheck(L_4);
				Finger_tF0FFA146E12F3DEF1F354487835AA90A59834AB8* L_5 = ((Link_t3E237FC972997681510F43C6555571385C91BE05*)L_4)->___Finger;
...
IL_0026_1:
			{
				bool L_8;
				L_8 = Enumerator_MoveNext_mE921CC8F29FBBDE7CC3209A0ED0D921D58D00BCB((&V_0), il2cpp_rgctx_method(method->rgctx_data, 6));
				if (L_8)
				{
					goto IL_000c_1;
				}
